...
#include "stanExports_msm_constant_continuous.h"

RCPP_MODULE(stan_fit4msm_constant_continuous_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_msm_constant_continuous")
