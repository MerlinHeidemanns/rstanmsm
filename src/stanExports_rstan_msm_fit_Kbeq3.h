...
namespace model_rstan_msm_fit_Kbeq3_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_rstan_msm_fit_Kbeq3");
    reader.add_event(122, 120, "end", "model_rstan_msm_fit_Kbeq3");
    return reader;
}
#include <stan_meta_header.hpp>
class model_rstan_msm_fit_Kbeq3 : public prob_grad {
private:
        int N;
        int T;
        int NT;
        ...
        vector_d y;
public:
    model_rstan_msm_fit_Kbeq3(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_rstan_msm_fit_Kbeq3_namespace::model_rstan_msm_fit_Kbeq3";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        validate_non_negative_index("lambda", "K", K);
        validate_non_negative_index("lambda", "K", K);
        context__.validate_dims("parameter initialization", "lambda", "vector_d", context__.to_vec(K,K,Md_var));
        std::vector<std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > > lambda(K, std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >(K, Eigen::Matrix<double, Eigen::Dynamic, 1>(Md_var)));
        size_t lambda_j_1_max__ = Md_var;
        size_t lambda_k_0_max__ = K;
        size_t lambda_k_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < lambda_j_1_max__; ++j_1__) {
            for (size_t k_1__ = 0; k_1__ < lambda_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < lambda_k_0_max__; ++k_0__) {
                    lambda[k_0__][k_1__](j_1__) = vals_r__[pos__++];
                }
            }
        }
        size_t lambda_i_0_max__ = K;
        size_t lambda_i_1_max__ = K;
        for (size_t i_0__ = 0; i_0__ < lambda_i_0_max__; ++i_0__) {
            for (size_t i_1__ = 0; i_1__ < lambda_i_1_max__; ++i_1__) {
                try {
                    writer__.vector_unconstrain(lambda[i_0__][i_1__]);
                } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 32;
            std::vector<std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > > lambda;
            size_t lambda_d_0_max__ = K;
            size_t lambda_d_1_max__ = K;
            lambda.resize(lambda_d_0_max__);
            for (size_t d_0__ = 0; d_0__ < lambda_d_0_max__; ++d_0__) {
                lambda[d_0__].reserve(lambda_d_1_max__);
                for (size_t d_1__ = 0; d_1__ < lambda_d_1_max__; ++d_1__) {
                    if (jacobian__)
                        lambda[d_0__].push_back(in__.vector_constrain(Md_var, lp__));
                    else
                        lambda[d_0__].push_back(in__.vector_constrain(Md_var));
                }
            }
            current_statement_begin__ = 35;
            ...
            validate_non_negative_index("A", "K", K);
            std::vector<std::vector<std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > > > A(N, std::vector<std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > >(T, std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> >(K, Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1>(K))));
            ...
            for (int nn = 1; nn <= N; ++nn) {
                ...
                for (int t = 1; t <= T; ++t) {
                    ...
                    for (int i = 1; i <= K; ++i) {
                        ...
                        validate_non_negative_index("den", "K", K);
                        std::vector<local_scalar_t__  > den(K, local_scalar_t__(DUMMY_VAR__));
                        stan::math::initialize(den, DUMMY_VAR__);
                        stan::math::fill(den, DUMMY_VAR__);
                        current_statement_begin__ = 51;
                        local_scalar_t__ den_sum(DUMMY_VAR__);
                        (void) den_sum;  // dummy to suppress unused var warning
                        stan::math::initialize(den_sum, DUMMY_VAR__);
                        stan::math::fill(den_sum, DUMMY_VAR__);
                        current_statement_begin__ = 52;
                        for (int j = 1; j <= K; ++j) {
                            current_statement_begin__ = 53;
                            if (as_bool(logical_neq(i, j))) {
                                current_statement_begin__ = 54;
                                stan::model::assign(den, 
                                            stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list()), 
                                            0.0, 
                                            "assigning variable den");
                            } else {
                                current_statement_begin__ = 56;
                                stan::model::assign(den, 
                                            stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list()), 
                                            stan::math::exp(multiply(get_base1(z_var, ((get_base1(get_base1(startstop, nn, "startstop", 1), 1, "startstop", 2) + t) - 1), "z_var", 1), get_base1(get_base1(lambda, i, "lambda", 1), j, "lambda", 2))), 
                                            "assigning variable den");
                            }
                        }
                        current_statement_begin__ = 59;
                        stan::math::assign(den_sum, log_sum_exp(den));
                        ...
                        for (int j = 1; j <= K; ++j) {
                            ...
                            if (as_bool(logical_eq(i, j))) {
                                ...
                                stan::model::assign(A, 
                                            stan::model::cons_list(stan::model::index_uni(nn), stan::model::cons_list(stan::model::index_uni(t), stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list())))), 
                                            stan::math::exp((stan::math::log(1) - stan::math::log((1 + den_sum)))), 
                                            "assigning variable A");
                            } else {
                                current_statement_begin__ = 64;
                                stan::model::assign(A, 
                                            stan::model::cons_list(stan::model::index_uni(nn), stan::model::cons_list(stan::model::index_uni(t), stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(j), stan::model::nil_index_list())))), 
                                            stan::math::exp((stan::math::log(stan::math::exp(multiply(get_base1(z_var, ((get_base1(get_base1(startstop, nn, "startstop", 1), 1, "startstop", 2) + t) - 1), "z_var", 1), get_base1(get_base1(lambda, i, "lambda", 1), j, "lambda", 2)))) - stan::math::log(den_sum))), 
                                            "assigning variable A");
                            }
                        }
                        }
            ...
            for (int i = 1; i <= Md_var; ++i) {
                current_statement_begin__ = 108;
                for (int j = 1; j <= K; ++j) {
                    current_statement_begin__ = 109;
                    lp_accum__.add(normal_log(stan::model::rvalue(lambda, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(j), stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()))), "lambda"), 0, 2));
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_rstan_msm_fit_Kbeq3_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        std::vector<std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > > lambda;
        size_t lambda_d_0_max__ = K;
        size_t lambda_d_1_max__ = K;
        lambda.resize(lambda_d_0_max__);
        for (size_t d_0__ = 0; d_0__ < lambda_d_0_max__; ++d_0__) {
        ...
        for (size_t j_1__ = 0; j_1__ < lambda_j_1_max__; ++j_1__) {
            for (size_t k_1__ = 0; k_1__ < lambda_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < lambda_k_0_max__; ++k_0__) {
                    vars__.push_back(lambda[k_0__][k_1__](j_1__));
                }
            }
        }
        ...
        try {
            ...
            validate_non_negative_index("A", "T", T);
            validate_non_negative_index("A", "K", K);
            std::vector<std::vector<std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > > > A(N, std::vector<std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > >(T, std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> >(K, Eigen::Matrix<double, Eigen::Dynamic, 1>(K))));
            stan::math::initialize(A, DUMMY_VAR__);
            stan::math::fill(A, DUMMY_VAR__);
    ...
    static std::string model_name() {
        return "model_rstan_msm_fit_Kbeq3";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < lambda_j_1_max__; ++j_1__) {
            for (size_t k_1__ = 0; k_1__ < lambda_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < lambda_k_0_max__; ++k_0__) {
                    param_name_stream__.str(std::string());
                    param_name_stream__ << "lambda" << '.' << k_0__ + 1 << '.' << k_1__ + 1 << '.' << j_1__ + 1;
                    param_names__.push_back(param_name_stream__.str());
                }
            }
        }
...
typedef model_rstan_msm_fit_Kbeq3_namespace::model_rstan_msm_fit_Kbeq3 stan_model;
#endif
