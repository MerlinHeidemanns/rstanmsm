...
namespace model_msm_constant_continuous_v2_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_msm_constant_continuous_v2");
    reader.add_event(203, 201, "end", "model_msm_constant_continuous_v2");
    return reader;
}
#include <stan_meta_header.hpp>
class model_msm_constant_continuous_v2 : public prob_grad {
private:
        int N;
        int T;
        int NT;
        ...
        int Mx_e_ord;
public:
    model_msm_constant_continuous_v2(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_msm_constant_continuous_v2_namespace::model_msm_constant_continuous_v2";
    ...
    ~model_msm_constant_continuous_v2() { }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_msm_constant_continuous_v2_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_msm_constant_continuous_v2";
    }
...
typedef model_msm_constant_continuous_v2_namespace::model_msm_constant_continuous_v2 stan_model;
#endif
