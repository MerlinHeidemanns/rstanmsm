...
#include "stanExports_rstan_msm_fit_Kbeq3.h"

RCPP_MODULE(stan_fit4rstan_msm_fit_Kbeq3_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_rstan_msm_fit_Kbeq3")
