...
#' @note Sort internally?
#' @param gamma shared parameters of the discrete process
#' @param lambda varying parameters of the discrete process
#' @param zeta shared parameters of the continuous process
#' @param beta varying parameters of the continuous process
